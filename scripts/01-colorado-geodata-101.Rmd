...
header-includes:
  - \geometry{paperwidth=200mm, paperheight=2300mm}
  - \color{black}
...
Huh, the appears to be a similar little "hitch" profile in GOP share of vote as well proceed up the per capita income curve. Per capita incomes can differ significantly across counties (contrast Boulder with Pueblo), so let's normalize this view a bit by comparing across per capita income percentiles within counties:
...
Next, we'll do a review of Colorado's electoral history. Stay tuned!
